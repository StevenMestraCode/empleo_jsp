...
<%
    ...
    empleo trabajo = (empleo) request.getSession().getAttribute("empleo_buscarModificar");
%>
<!DOCTYPE html>
<html>
<head>
...
<center>
    ...
    <form action="<%=request.getContextPath()%>/empleo?accion=buscarModificar" method="post">
        <table>
            <tr>
    ...
    <%
        ...
        request.getSession().setAttribute("empleo_buscarModificar", null);
    %>
</center>
</body>
</html>
